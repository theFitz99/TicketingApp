        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('user.details', $user->id) }}/edit" autocomplete="off">
                        @csrf
                        @method('PUT')
                        <div class="form-row">
                            @if (\Auth::id() == $user->id)
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="password" class="form-control @error('newpassword_again') is-invalid @enderror" id="inputNewPasswordAgain" name="newpassword_again">
